...
const Header: React.FC<Props> = () => (
  <div className="h-auto py-4 lg:py-0 lg:h-20 sticky w-full z-50 top-0 flex items-center shadow-sm bg-white">
    <div className="px-7 w-full flex flex-wrap justify-between items-center mx-auto">
      ...
      >
        <Link className="flex text-xl font-semibold" to="/">
          ...
          <span className="hidden sm:inline ml-2 font-heading">Square</span>
        </Link>
      </div>

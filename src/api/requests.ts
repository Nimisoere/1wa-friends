...
export const makeRequest = async (
  ...
  try {
    const response = await api.instance.request({
      headers: {
        Authorization:
          'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..9OvBdzyG9bs9yHSk4RK68nA0RBLDl0ipEp7Q3_gD2Kg',
      },
      ...api.request,
      url: apiUrl,
      ...apiOptions,
